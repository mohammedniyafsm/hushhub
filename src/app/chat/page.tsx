...
function Page() {
  return (
    <div className="flex justify-center items-center py-10">
      <div className="flex flex-col h-[650px] w-[1000px] border bg-card rounded-2xl">

=        <div className="flex justify-between items-center px-8 py-2 h-24 border-b">

          <div className="flex items-center gap-4">
            <div className="flex justify-center items-center bg-gray-50/[.10] rounded-lg h-9 w-9">
              <CiMail />
            </div>
        ...
        <div className="h-[470px] flex flex-col border-b py-4 px-2 overflow-y-auto gap-2">
          ...
          <Button className="w-fit max-w-[60%] rounded-xl px-4 py-2 text-left">I'm fine</Button>
        </div>
